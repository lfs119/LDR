...
path="/raid/home/xukai/FRATTVAE/results/admet_data_filtered_molecules_lrrk2_0_struct_1118"
path="/raid/home/xukai/FRATTVAE/results/admet_data_filtered_molecules_lrrk2_0.5_split_0.90_0.05_0.05_struct_1121"
path="/raid/home/xukai/FRATTVAE/results/admet_data_filtered_molecules_hpk1_0.5_split_0.90_0.05_0.05_struct_1127"
path="/raid/home/xukai/FRATTVAE/results/admet_data_filtered_molecules_hpk1_0.5_0.7_split_0.90_0.05_0.05_struct_0112"
ymlFile=$path'/input_data/params.yml'
load_epoch=-1

# python3 preprocessing.py ${ymlFile} --n_jobs 16 --biosynfoni >> $path'/preprocess_biosynfoni_hpk1_0.5.log' &
...
python3  -W ignore test.py ${ymlFile} --N 3 --k 10000 --gpu 2 --n_jobs 24 --gen > $path'/test.log' &
