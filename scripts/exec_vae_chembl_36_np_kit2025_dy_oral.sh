...
path="/raid/home/xukai/FRATTVAE/results/chembl_36_20251023_r1r10w1100w900_standardized_f_dyn_oral_struct_1111"
ymlFile=$path'/input_data/params.yml'
load_epoch=0

# python3 preprocessing.py ${ymlFile} --n_jobs 16 --biosynfoni >> $path'/preprocess_chebml_36_dy_oral_biosynfoni.log' &
# python3 preprocessing.py ${ymlFile} --n_jobs 16 >> $path'/preprocess_chebml_36_dy_oral_ecfp.log' &
...
python3  -W ignore test.py ${ymlFile} --N 3 --k 10000 --gpu 1 --n_jobs 16 --gen > $path'/test.log' &
