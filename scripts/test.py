...
parser.add_argument('--n_jobs', type= int, default= 10, help= 'the number of cpu for parallel, default 24')
...
if args.recon:
    ...
    for mode, value in modes.items():           #  modes = {'train': 0, 'valid': -1, 'test': 1}
