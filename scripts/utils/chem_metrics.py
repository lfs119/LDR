...
def get_additional_metrics(mol) -> dict:
    if type(mol) == str:
         return [func(mol) for func in ADDITIONAL_METRICS_DICT.values()]
...
# ADDITIONAL_METRICS_DICT = {'QEPPI': metrics.qeppi,
#                            'QRCI': metrics.qrci,
#                            'SPS': metrics.sps,
#                            'NSPS': metrics.nsps}
...
# ADDITIONAL_METRICS_DICT = {'QRCI': metrics.qrci}